...
class RemoteServices {
  ...
  static Future<AdsData?> fetchFilters() async {
    AdsData headers;
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/mainAds';
    Map data = {
      'ownerId':'',
    };
  ...
  static Future<AdsTwoData?> fetchAds(String memberId) async {
    AdsTwoData headers;
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/ads';
    Map data = {
      'ownerId':memberId,
    };
    var body = json.encode(data);
  ...
  static Future<MemberData?> fetchMembers() async {
    MemberData headers;
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/getAllmembers';
    Map data = {
      "priority":"1",
      "ownerId":"",
      "ownerName":"",
  ...
  static Future<Member2Data?> fetchCommittee() async {
    Member2Data headers;
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/getAllExecutiveCommitteeMembers';
    Map data = {};
    var body = json.encode(data);
    print(body);
    var response = await http.post(Uri.parse(url), headers: {"Content-Type": "application/json"},
  ...
  static Future<HolidayModel?> fetchHoliday() async {
    ...
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/holidayCalendar';
  ...
  static Future<UsefulModel?> fetchUseful() async {
    UsefulModel headers;
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Masters/getAllUsefulMaster';
  ...
  static Future<ContactModel?> fetchContact(String value) async {
    ...
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/getUsefulInformation';

    // from-data
    var map = new Map<String, dynamic>();
    map['page'] = '1';
    map['memberId'] = '5';
    map['masterInfoId'] = value;
  ...
  static Future<AlphaMemberModel?> fetchAlphaMember(String member,String value) async {
    ...
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/getAllFirmOwnersBySearch';
  ...
  static Future<EnquiryModel?> fetchEnquiry() async {
    ...
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/getAllEnquires';
  ...
  static Future<MemberProfileModel?> fetchProfile(String value) async {
    ...
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/memberprofile';
    // from-data
    var map = new Map<String, dynamic>();
    map['id'] = value;
    var response = await http.post(Uri.parse(url),body:map);
  ...
  static Future<AddEnquiryModel?> addEnquiry(String title,String name,String mobile,String desc) async {
    ...
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/addEnquiry';
  ...
  static Future<NewsModel?> fetchNews() async {
    NewsModel headers;
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/getAllNews';
    // from-data
    var map = new Map<String, dynamic>();
    map['page'] = '1';
    var response = await http.post(Uri.parse(url),
  ...
  static Future<UpdateMemberModel?> UpdateMember(String id,String name,String lifeline,String spouse,String father
    ...
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/updateMember';
  ...
  static Future<UpdateMemberModel?> Children(String id,String name,String remark) async {
    UpdateMemberModel headers;
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/addMemberChildren';
  ...
  static Future<UpdateMemberModel?> ChildrenDelete(String id) async {
    UpdateMemberModel headers;
    var url ='http://japps.co.in/apexmouda/nismwa_api/index.php/Member/deleteMemberChildren';
    var map = new Map<String, dynamic>();
    map['child_id'] = id;
    print(id);
    var response = await http.post(Uri.parse(url),body:map);
