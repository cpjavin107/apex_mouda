...
import 'package:apex_mouda/pages/useful_details/useful_detail_page.dart';
                        ...
                        child: linksData.status != 0 ? ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Card(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => Useful_Detail_Page(value :linksData.data?[index].id??"", title: linksData.data?[index].uName,) ));
                                  },
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Column(
