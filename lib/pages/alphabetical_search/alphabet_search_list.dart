...
import 'package:apex_mouda/models/adssecond.dart';
         ...
         if(snapshot.hasData){
           ...
           return Scaffold(
             ...
             body: Stack(
               ...
               children:<Widget> [
                 Expanded(
                   child:  alphaData?.status != 0  ?ListView.builder(
                           ...
                           child: Column(
                             children: [
                               Card(
                                 ...
                                 child: InkWell(
                                   onTap: () {
                                     Navigator.of(context).push(new MaterialPageRoute(builder: (_)=>new Alpha_detail_Page(value :alphaData!.data?[index].id??"",)),)
                                             ...
                                             children: [
                                               Padding(
                                                 ...
                                                 child: Container(
                                                   ...
                                                   child: Container(child: alphaData!.data?[index].image == "" ?
                                                   CircleAvatar(backgroundImage:AssetImage("assets/images/profile_icon.png"),)
                                                       :
                                                   CircleAvatar(radius: 30.0,backgroundImage: NetworkImage(alphaData!.data?[index].image?? ""),),),),
                                               ),
                                               Expanded(
                                                 child: Column(
                                                   mainAxisAlignment: MainAxisAlignment.center,
